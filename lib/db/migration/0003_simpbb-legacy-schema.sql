...
CREATE TABLE `ref_kelurahan` (
	...
	CONSTRAINT `ref_kelurahan_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_SEKTOR`)
);
--> statement-breakpoint
...
CREATE TABLE `spop` (
	...
	CONSTRAINT `spop_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`)
);
--> statement-breakpoint
CREATE TABLE `dat_fasilitas_bangunan` (
	...
	CONSTRAINT `dat_fasilitas_bangunan_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`,`NO_BNG`,`KD_FASILITAS`)
);
--> statement-breakpoint
CREATE TABLE `dat_op_bangunan` (
	...
	`AKTIF` tinyint NOT NULL DEFAULT 1,
	CONSTRAINT `dat_op_bangunan_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`,`NO_BNG`)
);
--> statement-breakpoint
CREATE TABLE `dat_legalitas_bumi` (
	...
	CONSTRAINT `dat_legalitas_bumi_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`)
);
--> statement-breakpoint
CREATE TABLE `dat_op_anggota` (
	...
	CONSTRAINT `dat_op_anggota_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`)
);
--> statement-breakpoint
CREATE TABLE `dat_op_induk` (
	...
	`NO_URUT` char(4) NOT NULL,
	`KD_JNS_OP` char(1) NOT NULL,
	CONSTRAINT `dat_op_induk_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`)
);
--> statement-breakpoint
...
CREATE TABLE `sppt` (
	...
	CONSTRAINT `sppt_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`,`THN_PAJAK_SPPT`)
);
--> statement-breakpoint
CREATE TABLE `sppt_khusus` (
	...
	CONSTRAINT `sppt_khusus_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`)
);
--> statement-breakpoint
CREATE TABLE `status_pbb` (
	...
	`TGL_SK` date,
	CONSTRAINT `status_pbb_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`,`TAHUN_PBB`)
);
--> statement-breakpoint
CREATE TABLE `pembayaran_sppt` (
	...
	`TGL_BATAL` datetime,
	`ALASAN_BATAL` text,
	CONSTRAINT `pembayaran_sppt_pk` PRIMARY KEY(`KD_PROPINSI`,`KD_DATI2`,`KD_KECAMATAN`,`KD_KELURAHAN`,`KD_BLOK`,`NO_URUT`,`KD_JNS_OP`,`THN_PAJAK_SPPT`,`PEMBAYARAN_KE`)
);
--> statement-breakpoint
