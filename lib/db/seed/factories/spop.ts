...
export function createSpop(
  ...
  return {
    ...
    nipPendata: randNumber({ min: 100000000, max: 999999999 }).toString().substring(0, 20),
    tglPemeriksaanOp: randPastDate(),
    nmPemeriksaanOp: randIdName().toUpperCase().substring(0, 30),
    nipPemeriksaOp: randNumber({ min: 100000000, max: 999999999 }).toString().substring(0, 20),
    ...overrides,
