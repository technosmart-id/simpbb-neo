...
export const sppt = mysqlTable("sppt", {
  ...
  thnAwalKlsTanah: char("THN_AWAL_KLS_TANAH", { length: 4 }).default("2000"),
  kdKlsBng: varchar("KD_KLS_BNG", { length: 3 }),
  thnAwalKlsBng: char("THN_AWAL_KLS_BNG", { length: 4 }).default("2000"),
  tglJatuhTempoSppt: date("TGL_JATUH_TEMPO_SPPT"),
  luasBumiSppt: bigint("LUAS_BUMI_SPPT", { mode: "number" }).notNull().default(0),
  luasBngSppt: bigint("LUAS_BNG_SPPT", { mode: "number" }).notNull().default(0),
  njopBumiSppt: bigint("NJOP_BUMI_SPPT", { mode: "number" }).notNull().default(0),
  njopBngSppt: bigint("NJOP_BNG_SPPT", { mode: "number" }).notNull().default(0),
